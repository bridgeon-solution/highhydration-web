...
<div className="w-full sm:w-6/12 md:w-6/12 lg:w-3/12 px-3 text-center mb-5 ">
  <div className="py-4 border rounded-lg bg-gray-200 shadow-xl">
    <h6 className="mb-2 text-transparent z-1 bg-clip-text bg-black text-lg font-semibold tracking-wide">Total Orders</h6>
...
<div className="w-full sm:w-6/12 md:w-6/12 lg:w-3/12 px-3 text-center mb-5 ">
  <div className="py-4 border rounded-lg bg-gray-200 shadow-xl">
    <h6 className="mb-2 text-transparent z-1 bg-clip-text bg-gradient-to-tl from-green-700 to-green-500 text-lg font-semibold tracking-wide">Completed</h6>
    <div className="flex items-center justify-center">
...
<div className="w-full sm:w-6/12 md:w-6/12 lg:w-3/12 px-3 text-center mb-5 ">
  <div className="py-4 border rounded-lg bg-gray-200 shadow-xl">
    <h6 className="mb-2 text-transparent z-1 bg-clip-text bg-gradient-to-tl from-red-700 to-red-500 text-lg font-semibold tracking-wide">Processing</h6>
    <div className="flex items-center justify-center">
...
<div className="w-full sm:w-6/12 md:w-6/12 lg:w-3/12 px-3 text-center mb-5 ">
  <div className="py-4 border rounded-lg bg-gray-200 shadow-xl">
    <h6 className="mb-2 text-transparent z-1 bg-clip-text bg-gradient-to-tl from-blue-500 to-blue-800 text-lg font-semibold tracking-wide">Stock</h6>
    <div className="flex items-center justify-center">
      <h6 className="mb-2 text-transparent z-1 bg-clip-text bg-gradient-to-tl from-blue-500 to-blue-800  text-lg font-bold tracking-wide">210</h6>
    </div>
  </div>
</div>
