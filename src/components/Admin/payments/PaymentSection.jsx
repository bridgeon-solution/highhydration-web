...
const currentDate = new Date(Date.now());
  ...
  <div className='bg-blue-100 w-11/12 lg:w-1/3 h-32 rounded-lg text-start pl-3'>
  ...
  <div className='bg-green-100 w-11/12 lg:w-1/3 h-32 rounded-lg pl-3'>
    <p className='text-gray-500 font-light text-lg'>Success Amount</p>
    <p className='text-green-500 font-semibold text-2xl'>${success}</p>
    <span className='text-end mx-1 font-light text-gray-400'>{formattedDate}</span>
  </div>
  <div className='bg-red-100 w-11/12 lg:w-1/3 h-32 rounded-lg pl-3'>
